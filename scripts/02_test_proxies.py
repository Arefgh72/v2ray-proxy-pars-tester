...
def test_proxy(proxy: str) -> dict:
    ...
    try:
        ...
        # مرحله ۴: اطمینان از بسته شدن فرآیند
...
def main():
    print("🚀 شروع تست پراکسی‌های اصلی (V2Ray) با روش فایل اصلی...")
